"""Acceptance tests for Turkey Inventory expansion package 2."""
# ruff: noqa: D103
...
PLATFORMS = (
    ...
    (
        ...
        "CASA CN-235",
        "CN235",
        "VIDEO_RAW_CN235_DEFAULT",
        "NAKLIYE_UCAGI",
        "hafif askeri nakliye ucagi",
    ),
    (
        "PLT_BOEING_E7",
        "Boeing E-7",
        "E7",
        "VIDEO_RAW_BOEING_E7_DEFAULT",
        "NAKLIYE_UCAGI",
        "havadan erken ihbar ve kontrol ucagi",
    ),
)
...
def test_package2_registry_alias_inventory_and_routes(
    platform_id: str,
    canonical_name: str,
    alias: str,
    video_id: str,
...
async def test_package2_raw_vlm_end_to_end_is_verified_low(
    platform_id: str,
    canonical_name: str,
    _alias: str,
    video_id: str,
...
def test_package2_ui_catalog_is_registry_and_inventory_backed() -> None:
    ...
    assert catalog["PLT_HURKUS"]["user_type"] == "Sava\u015f u\u00e7a\u011f\u0131"
    for platform_id in ("PLT_C130", "PLT_CN235", "PLT_BOEING_E7"):
        assert catalog[platform_id]["user_type"] == "Nakliye u\u00e7a\u011f\u0131"


def test_package2_keeps_existing_demo_scenarios_unchanged() -> None:
