"""Acceptance tests for Turkey Inventory expansion package 4."""
# ruff: noqa: D103
...
def test_package4_registry_alias_inventory_and_routes(
    platform_id: str,
    canonical_name: str,
    alias: str,
    video_id: str,
...
async def test_package4_raw_vlm_end_to_end_is_verified_low(
    platform_id: str,
    canonical_name: str,
    _alias: str,
    video_id: str,
...
def test_package4_ui_catalog_is_registry_and_inventory_backed() -> None:
    ...
    assert catalog["PLT_STM_ALPAGU"]["user_type"] == "S\u0130HA"
    assert catalog["PLT_F4E_2020"]["user_type"] == "Sava\u015f u\u00e7a\u011f\u0131"


def test_package4_keeps_existing_demo_scenarios_unchanged() -> None:
